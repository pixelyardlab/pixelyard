#!/bin/zsh -l
#
# claude-code-starten.command — Claude Code im Projektordner pixelyard starten.
#
# Doppelklick im Finder, oder im Terminal: ./werkzeuge/claude-code-starten.command
#
...
#
# Argumente werden durchgereicht: ./werkzeuge/claude-code-starten.command "Bitte ..."
